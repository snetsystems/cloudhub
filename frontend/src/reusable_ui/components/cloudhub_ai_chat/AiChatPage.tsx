  ...
  const customPanelViews: CustomPanelView[] = [
    {
      ...
      component: (
        ...
        >
          <h4 style={{color: '#63b3ed', margin: 0}}>
          ...
          >
            ...
            >
              ...
              <div
                style={{fontSize: '20px', fontWeight: 'bold', color: '#68d391'}}
              >
                34.2%
              </div>
            </div>
            ...
            >
              ...
              <div
                style={{fontSize: '20px', fontWeight: 'bold', color: '#f6ad55'}}
              >
                6.4 / 16 GB
              </div>
            </div>
          ...
          >
            ...
            >
              <li>
                openclaw-gateway-v2:{' '}
                <span style={{color: '#68d391'}}>Healthy</span>
              </li>
              <li>
                subagent-runner-pool:{' '}
                <span style={{color: '#68d391'}}>Healthy (3 Workers)</span>
              </li>
              <li>
                influxdb-telemetry:{' '}
                <span style={{color: '#68d391'}}>Healthy</span>
    ...
    },
    {
      ...
      component: (
        ...
        >
          <h4 style={{color: '#f6ad55', margin: 0}}>
