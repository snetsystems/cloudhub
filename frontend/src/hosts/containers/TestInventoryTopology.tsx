...
class TestInventoryTopology extends PureComponent<Props, State> {
  constructor(props: Props) {
    super(props)

    this.state = {
      boxLayout: this.layout,
                    ...
                    <>
                      <div id="contentBodySection">
                        <div id="graphContainer" ref={this.containerRef}>
                          {/* {this.state.topologyStatus ===
                            RemoteDataState.Loading && <PageSpinner />} */}
                          <div
                            id="outlineContainer"
                            ref={this.outlineRef}
                          ></div>
