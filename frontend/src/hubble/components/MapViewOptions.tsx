...
const VERDICT_OPTIONS: ReadonlyArray<{value: VerdictFilter; label: string; title: string}> = [
...
const MapViewOptions: React.FC<Props> = ({
  ...
  <div className="hubble-map-options" role="group" aria-label="Map view options">
    <div className="hubble-verdict-filter" role="radiogroup" aria-label="Verdict filter">
