      ...
      <Page.Header inPresentationMode={inPresentationMode}>
        ...
        <Page.Header.Right showSourceIndicator={true}>
          ...
          <AutoRefreshDropdown
            ...
            customAutoRefreshOptions={getTimeOptionByGroup('openstack')}
            customAutoRefreshSelected={cloudAutoRefresh}
          />
          <TimeRangeDropdown
            onChooseTimeRange={handleChooseTimeRange}
            selected={cloudTimeRange?.openstack ?? DEFAULT_TIME_RANGE}
          />
          <Button
      ...
      <Page.Contents scrollable={true} fullWidth={true}>
        <>
          <OpenStackPage
            ...
            timeRange={cloudTimeRange?.openstack ?? DEFAULT_TIME_RANGE}
...
export default connect(mstp, mdtp, null)(ManualRefresh<Props>(OpenStackRouter))
