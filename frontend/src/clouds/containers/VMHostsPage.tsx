...
import HostModal from 'src/clouds/components/HostModal'
import VMTreeMenu from 'src/clouds/components/VMTreeMenu'
import VcenterTable from 'src/clouds/components/VcenterTable'
import DatacentersTable from 'src/clouds/components/DatacentersTable'
import DatacenterTable from 'src/clouds/components/DatacenterTable'
import DatastoresTable from 'src/clouds/components/DatastoresTable'
import ClustersTable from 'src/clouds/components/ClustersTable'
import ClusterTable from 'src/clouds/components/ClusterTable'
import VMHostsTable from 'src/clouds/components/VMHostsTable'
import VMHostTable from 'src/clouds/components/VMHostTable'
import VirtualMachinesTable from 'src/clouds/components/VirtualMachinesTable'
import VirtualMachineTable from 'src/clouds/components/VirtualMachineTable'
import ChartsLayoutRenderer from 'src/clouds/components/ChartsLayoutRenderer'
import VMConnectForm from 'src/clouds/components/VMConnectForm'
...
import {
  ...
  hostCells,
  vmCells,
} from 'src/clouds/constants/layout'
