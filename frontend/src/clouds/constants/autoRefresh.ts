  ...
  return (
    {
      ...
      kubernetesHeader: [
        ...
        {...autoRefreshOptionPaused, group: groupName},
        {
          id: 'auto-refresh-1m-kubernetesHeader',
          milliseconds: 60000,
          label: '1m',
          type: AutoRefreshOptionType.Option,
          group: groupName,
        ...
        {
          id: 'auto-refresh-2m-kubernetesHeader',
          milliseconds: 120000,
          label: '2m',
          type: AutoRefreshOptionType.Option,
          group: groupName,
        ...
        {
          id: 'auto-refresh-3m-kubernetesHeader',
          milliseconds: 180000,
          label: '3m',
          type: AutoRefreshOptionType.Option,
          group: groupName,
        ...
        {
          id: 'auto-refresh-5m-kubernetesHeader',
          milliseconds: 300000,
          label: '5m',
          type: AutoRefreshOptionType.Option,
          group: groupName,
        ...
        {
          id: 'auto-refresh-7m-kubernetesHeader',
          milliseconds: 420000,
          label: '7m',
          type: AutoRefreshOptionType.Option,
          group: groupName,
        ...
        {
          id: 'auto-refresh-10m-kubernetesHeader',
          milliseconds: 600000,
          label: '10m',
          type: AutoRefreshOptionType.Option,
          group: groupName,
      ...
      urlMonitoring: autoRefreshGroupDefaultOption(groupName, 'urlMonitoring'),
