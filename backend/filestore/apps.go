...
type Apps struct {
	...
	Filename func(string, cloudhub.Layout) string             // Filename takes dir and layout and returns loadable file
	Create   func(string, cloudhub.Layout) error              // Create will write layout to file.
...
func fileName(dir string, layout cloudhub.Layout) string {
...
func createLayout(file string, layout cloudhub.Layout) error {
	...
	if octets, err := json.MarshalIndent(layout, "    ", "    "); err != nil {
		return cloudhub.ErrLayoutInvalid
...
func (a *Apps) Add(ctx context.Context, layout cloudhub.Layout) (cloudhub.Layout, error) {
	var err error
	...
	if err = a.Create(file, layout); err != nil {
		if err == cloudhub.ErrLayoutInvalid {
			a.Logger.
				WithField("component", "apps").
				WithField("name", file).
...
func (a *Apps) Delete(ctx context.Context, layout cloudhub.Layout) error {
...
func (a *Apps) Update(ctx context.Context, layout cloudhub.Layout) error {
