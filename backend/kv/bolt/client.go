...
const (
	...
	defaultBoltPath = "cloudhub-v1.db"
)
...
func WithBuildInfo(bi cloudhub.BuildInfo) Option {
...
func (c *client) backup(ctx context.Context, lastBuild, build cloudhub.BuildInfo) error {
