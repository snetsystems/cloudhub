...
type Server struct {
	...
	LogLevel          string `short:"l" long:"log-level" value-name:"choice" choice:"debug" choice:"info" choice:"error" choice:"warning" default:"info" description:"Set the logging level" env:"LOG_LEVEL"`
